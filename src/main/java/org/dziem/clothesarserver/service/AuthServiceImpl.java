...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(UserService userService, UserRepository userRepository, JwtProvider jwtProvider, PasswordEncoder passwordEncoder, StringRedisTemplate redisTemplate) {
